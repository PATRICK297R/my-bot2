...
`.trim()
            ...
            break	
            case 'assalamualaikum': case "Assalamualaikum": case 'asalamualaikum': case `Assalamu'alaikum`: case "assalamu'alaikum": {
...
`.trim()
                ...
                XeonBotInc.sendMessage(m.chat, { audio: fs.readFileSync(pl.path), fileName: anupk.title + '.mp3', mimetype: 'audio/mp4' }, { quoted: m })
            }
            break
